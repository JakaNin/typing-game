...
const ReloadIcon: React.FC<IconProps> = ({
  ...
  const gradientStart = getTailwindColor("ap-orange-700");
  const gradientEnd = getTailwindColor("ap-orange-500");
  return (
    <svg
      fill={gradient ? "url(#reloadGradient)" : fillColor}
      width="30px"
      height="30px"
      viewBox="0 0 512 512"
    ...
    >
      {gradient && (
        <defs>
          <linearGradient id="reloadGradient" x1="0" x2="100%" y1="0" y2="100%">
